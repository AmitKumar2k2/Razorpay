...
const features = [
  {
    ...
    description: 'Accept payments with 100+ payment modes and experience the best success rates in the industry',
  },
  {
    icon: Link2,
    title: 'Payment Links',
    description: 'Share payment links via email, SMS, or social media and get paid instantly without a website',
  },
  {
    icon: RefreshCw,
    title: 'Subscriptions',
    description: 'Automate recurring payments and manage your subscription business with ease',
  },
  {
    icon: Wallet,
    title: 'Smart Collect',
    description: 'Automate payment collection and reconciliation with virtual accounts',
  },
  {
    icon: BarChart3,
    title: 'Analytics & Reports',
    description: 'Get real-time insights into your payments with powerful analytics and reports',
  },
  {
    icon: Globe,
    title: 'International Payments',
    description: 'Accept international payments in 100+ currencies with automatic conversion',
  },
];
        ...
        <div className="flex flex-col items-center gap-6 max-w-5xl mx-auto">
          {features.map((feature, index) => (
            <div
              ...
              className="w-full bg-gradient-to-br from-gray-900 to-gray-800 border border-emerald-500/20 rounded-2xl p-8 md:p-10 hover:border-emerald-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-500/10 group cursor-pointer"
            >
